...
`npm run check` includes pure stdio MCP client coverage for initialize, `tools/list`, and success/failure calls for the five tools. Real OAuth is intentionally opt-in and is not proof from source tests.
